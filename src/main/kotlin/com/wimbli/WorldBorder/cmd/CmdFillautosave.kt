...
class CmdFillautosave : WBCmd() {
    ...
    override fun cmdStatus(sender: CommandSender) {
        ...
        if (seconds == 0) {
            ...
            sender.msg(C_HEAD + "Note that much progress can be lost this way if there is a bug or crash in " +
            ...
            sender.msg(C_HEAD + "New chunks generated by the Fill process will be forcibly saved to disk " +
